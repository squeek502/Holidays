...
-- from: http://rosettacode.org/wiki/Number_names#Lua
]]--
local function numbertoword( val )
	...
	if #vword == 0 then return "zero" else return vword:gsub("^%s+", ""):gsub("%s+$", "") end

end
M.numbertoword = numbertoword
...
M.capitalizeword = capitalizeword

local function capitalize( str )
	return (str:gsub("%a+", capitalizeword))
end
